...
3. Install steam
4. Do not install Firefox, instead install Goobifox
5. Use reversal-green-dark icon theme: https://store.kde.org/p/1340791
6. Install Ant-Dark Plasma style: https://store.kde.org/p/1464321
7. Set accent color to #3e723b
8. Disable top-left to overview in screen edges (hot corners) setting
9. Disable pointer acceleration
10. Disable middle click to paste
11. Desktop folder settings, mouse actions: disable middle click to do anything
